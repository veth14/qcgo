      ...
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-gray-600 mb-8">
            Subscribe to our newsletter and get notified of city updates
          </p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
            <input
              ...
              placeholder="Enter your email to get notified of city updates"
              className="flex-grow px-4 py-3 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary"
              required
            />
            <button
              type="submit"
              className="bg-primary hover:bg-blue-800 text-white font-bold py-3 px-6 rounded-md transition duration-300"
            >
              Send
            </button>
          </form>
