    ...
    <footer className="bg-primary text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">QCGO</h3>
            <p className="text-sm">Explore Quezon City with us!</p>
          </div>
          <div>
            <h3 className="text-lg font-semibold mb-4">CONTACT US</h3>
            <p className="text-sm mb-2">Email: info@qcgo.com</p>
            <p className="text-sm">Phone: +63 123 456 7890</p>
          </div>
          <div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} QCGO. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
